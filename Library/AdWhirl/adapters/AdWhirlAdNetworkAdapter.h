...
@interface AdWhirlAdNetworkAdapter : NSObject {
  id<AdWhirlDelegate> __unsafe_unretained adWhirlDelegate;
  AdWhirlView *__unsafe_unretained adWhirlView;
...
@property (nonatomic,unsafe_unretained) id<AdWhirlDelegate> adWhirlDelegate;
@property (nonatomic,unsafe_unretained) AdWhirlView *adWhirlView;
@property (nonatomic,strong) AdWhirlConfig *adWhirlConfig;
@property (nonatomic,strong) AdWhirlAdNetworkConfig *networkConfig;
@property (nonatomic,strong) UIView *adNetworkView;
