...
@property (strong) AdWhirlConfig *config;
@property (strong) NSMutableArray *prioritizedAdNetCfgs;
@property (nonatomic,strong) AdWhirlAdNetworkAdapter *currAdapter;
@property (nonatomic,strong) AdWhirlAdNetworkAdapter *lastAdapter;
@property (nonatomic,strong) NSDate *lastRequestTime;
@property (nonatomic,strong) NSTimer *refreshTimer;
@property (nonatomic) BOOL showingModalView;
@property (nonatomic,unsafe_unretained) AdWhirlConfigStore *configStore;
@property (nonatomic,strong) AWNetworkReachabilityWrapper *rollOverReachability;
@property (nonatomic,strong) NSArray *testDarts;
