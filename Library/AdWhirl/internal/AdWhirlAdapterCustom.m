...
@property (unsafe_unretained, nonatomic,readonly) CLLocationManager *locationManager;
@property (nonatomic,strong) NSURLConnection *adConnection;
@property (nonatomic,strong) NSURLConnection *imageConnection;
@property (nonatomic,strong) AdWhirlCustomAdView *adView;
@property (nonatomic,strong) AdWhirlWebBrowserController *webBrowserController;
