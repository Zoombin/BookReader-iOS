...
@interface AdWhirlView : UIView <AdWhirlConfigDelegate,
  ...
  id<AdWhirlDelegate> __unsafe_unretained delegate;
  ...
  NSError *__unsafe_unretained lastError;

  AdWhirlConfigStore *__unsafe_unretained configStore;
 ...
 */
@property (nonatomic, unsafe_unretained) IBOutlet id<AdWhirlDelegate> delegate;
