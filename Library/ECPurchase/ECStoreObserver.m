...
- (void) completeTransaction: (SKPaymentTransaction *)transaction {
	...
	UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"iap1" message:@"Purchase Successful, provide content"
...
#ifdef ECPURCHASE_TEST_MODE
	UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"iap2" message:@"Restore Transaction"
												   delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
	[alert show];
	[alert release];
#endif
...
#ifdef ECPURCHASE_TEST_MODE
	UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"iap3" message:@"failed Transaction"
												   delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
	[alert show];
	[alert release];
#endif
